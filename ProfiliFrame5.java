...
class NjomEza implements RoliInterface{

    private String emri;
    private String mbiemri;
    private int vitiLindjes = 2001;
    private int id=181944123;
    private char gjinia = 'F';

    public NjomEza() {
        emri = new String("Njom\u00EBza");
        mbiemri = new String("Ismaili");
...
public class ProfiliFrame5 extends JFrame{
   private JLabel labelaE,labelaM,labelaV,labelaA,labelaG,labelaR,labelaP;
    ...
    NjomEza n =new NjomEza();
    Korniza k=new Korniza();
    
    public ProfiliFrame5(){
        ...
        fushaE=new JTextField(n.getEmri(),15);
        fushaM=new JTextField(n.getMbiemri(),15);
        fushaV=new JTextField(n.VString());
        fushaA=new JTextField(n.IString());
        fushaG=new JTextField(n.GString());
        fushaR=new JTextField(n.roli());
        JButton close=new JButton("Close");
        close.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                int pergjigja = JOptionPane.showConfirmDialog(ProfiliFrame5.this, "A jeni i sigurte?");
