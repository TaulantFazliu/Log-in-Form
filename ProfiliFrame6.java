...
class Graniti implements RoliInterface {

    private String emri;
    private String mbiemri;
    private int vitiLindjes = 1993;
    private int mosha = 2019 - vitiLindjes;
    private char gjinia = 'M';

    public Graniti() {
        emri = new String("Granit");
...
public class ProfiliFrame6 extends JFrame {
   ...
   private JLabel labelaE,labelaM,labelaV,labelaA,labelaG,labelaR,labelaP;
    ...
    Graniti gr=new Graniti();
    Korniza k = new Korniza();

    public ProfiliFrame6() {
        ...
        fushaE = new JTextField(gr.getEmri(), 15);
        fushaM = new JTextField(gr.getMbiemri(), 15);
        fushaV = new JTextField(gr.VString());
        fushaA = new JTextField(gr.MString());
        fushaG = new JTextField(gr.GString());
        fushaR = new JTextField(gr.roli());
        JButton close=new JButton("Close");
        close.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                int pergjigja = JOptionPane.showConfirmDialog(ProfiliFrame6.this, "A jeni i sigurte?");
